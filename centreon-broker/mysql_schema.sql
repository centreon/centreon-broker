...
CREATE TABLE hosts (
  ...
  default_active_checks_enabled smallint default NULL,
  default_event_handler_enabled smallint default NULL,
  default_failure_prediction_enabled smallint default NULL,
  ...
  default_process_performance_data boolean default NULL,
  ...
  flap_detection_on_up smallint default NULL,
  ...
  PRIMARY KEY (id),
  UNIQUE KEY (host_id),
  UNIQUE KEY (host_name, instance_id),
...
CREATE TABLE hostgroups (
  ...
  PRIMARY KEY (id),
  UNIQUE KEY (hostgroup_name, instance_id),
  FOREIGN KEY (instance_id) REFERENCES programs (instance_id)
    ON DELETE CASCADE
) ENGINE=InnoDB;
...
CREATE TABLE host_hostgroup (
  ...
  UNIQUE KEY (host_id, hostgroup_id),
...
CREATE TABLE issues (
  ...
  PRIMARY KEY (id),
  UNIQUE KEY (host_id, service_id, start_time)
) ENGINE=InnoDB;
...
CREATE TABLE services (
  ...
  scheduled_downtime_depth smallint default NULL,
  should_be_scheduled boolean default NULL,
  stalk_on_critical smallint default NULL,
  stalk_on_ok smallint default NULL,
  stalk_on_unknown smallint default NULL,
  stalk_on_warning smallint default NULL,
  state_type smallint default NULL,

  PRIMARY KEY (id),
  UNIQUE KEY (host_id, service_description),
...
CREATE TABLE service_servicegroup (
  ...
  UNIQUE KEY (service_id, servicegroup_id),
