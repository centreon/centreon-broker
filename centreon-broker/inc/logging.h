 ...
 *  receive only specific messages like informational (INFO), debug (DEBUG) or
 *  error (ERROR).
 */
class                   Logging
{
...
# ifndef NDEBUG
#  define LOGDEBUG(msg) (logging.LogDebug(msg))
# else
#  define LOGDEBUG(msg) ((void)msg)
# endif /* !NDEBUG */
# define LOGERROR(msg) (logging.LogError(msg))
# define LOGINFO(msg) (logging.LogInfo(msg))
