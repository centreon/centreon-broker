...
/**
 *  @class object_cache object_cache.hh
 * "com/centreon/broker/notification/object_cache.hh"
...
class object_cache {
 public:
   ...
   */
  object_cache(object_cache<FullType, StatusType> const& obj) {
  ...
  void serialize(std::deque<std::shared_ptr<io::data> >& out) const {
    ...
    for (std::unordered_map<std::string,
                            neb::custom_variable_status>::const_iterator
   ...
   */
  void update(FullType const& n) { _node = n; }
   ...
   */
  FullType const& get_node() const { return _node; }
   ...
   */
  StatusType const& get_status() const { return (_current_status); }
   ...
   */
  StatusType const& get_prev_status() const { return (_prev_status); }
