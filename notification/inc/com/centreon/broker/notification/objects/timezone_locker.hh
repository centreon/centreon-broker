...
#ifndef CCB_NOTIFICATION_OBJECTS_TIMEZONE_LOCKER_HH
#  define CCB_NOTIFICATION_OBJECTS_TIMEZONE_LOCKER_HH
...
namespace   notification {
  namespace objects {
  /**
   *  @class timezone_locker timezone_locker.hh "com/centreon/broker/notifications/objects/timezone_locker.hh"
...
#endif // !CCB_NOTIFICATION_OBJECTS_TIMEZONE_LOCKER_HH
