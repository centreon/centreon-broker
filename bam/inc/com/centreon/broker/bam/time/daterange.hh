...
#ifndef CCB_BAM_TIME_DATERANGE_HH
#  define CCB_BAM_TIME_DATERANGE_HH
...
namespace             bam {
  namespace           time {
    /**
     *  @class daterange daterange.hh "com/centreon/broker/bam/time/daterange.hh"
...
#endif // !CCB_BAM_TIME_DATERANGE_HH
