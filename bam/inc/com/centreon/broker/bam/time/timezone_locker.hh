...
#ifndef CCB_BAM_TIME_TIMEZONE_LOCKER_HH
#  define CCB_BAM_TIME_TIMEZONE_LOCKER_HH
...
namespace   bam {
  namespace time {
  /**
   *  @class timezone_locker timezone_locker.hh "com/centreon/broker/bam/time/timezone_locker.hh"
...
#endif // !CCB_BAM_TIME_TIMEZONE_LOCKER_HH
