...
TEST_F(StorageParserParsePerfdata, Simple1) {
  ...
  storage::parser p;
  p.parse_perfdata(0, 0, "time=2.45698s;2.000000;5.000000;0.000000;10.000000", lst);
...
TEST_F(StorageParserParsePerfdata, Loop) {
  ...
  for (uint32_t i(0); i < 10000; ++i) {
    ...
    list.clear();
    p.parse_perfdata(0, 0, "c[time]=2.45698s;2.000000;5.000000;0.000000;10.000000",
                     list);
...
TEST_F(StorageParserParsePerfdata, BadMetric1) {
  ...
  std::list<storage::perfdata> lst;
  storage::parser p;
  ASSERT_NO_THROW(p.parse_perfdata(0, 0, "user1=1 user2=2 user4= user3=3", lst));
