...
The following chapters defines how to configure Centreon Broker directly
with plain-text files. This not however the recommended way to configure
...
Note: if you use configuration files generated by Centreon, you might
