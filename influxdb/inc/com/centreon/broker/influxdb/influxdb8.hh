...
#ifndef CCB_INFLUXDB_INFLUXDB8_HH
#  define CCB_INFLUXDB_INFLUXDB8_HH
...
namespace         influxdb {
   ...
   *  API.
   */
  class           influxdb8 : public influxdb::influxdb {
  public:
                  influxdb8(
                    ...
                    unsigned short port,
                    std::string const& db);
                  influxdb8(influxdb8 const& f);
                  ~influxdb8();
    influxdb8&    operator=(influxdb8 const& f);
...
#endif // !CCB_INFLUXDB_INFLUXDB8_HH
