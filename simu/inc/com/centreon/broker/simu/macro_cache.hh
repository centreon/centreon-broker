...
#ifndef CCB_SIMU_MACRO_CACHE_HH
#  define CCB_SIMU_MACRO_CACHE_HH
...
namespace         simu {
  /**
   *  @class macro_cache macro_cache.hh "com/centreon/broker/simu/macro_cache.hh"
