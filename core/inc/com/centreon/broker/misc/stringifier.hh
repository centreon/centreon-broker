  ...
  namespace                         centreon {
    namespace                       broker {
      namespace                     misc {
         ...
         *  them into a C-string (nul-terminated). Whereas stringifier
         *  has a maximum number of characters it can store, it's main
         *  advantage is that it is totally safe to use it (no exception
         *  will ever be thrown) and therefore make it suitable for
