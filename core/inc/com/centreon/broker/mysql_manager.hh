...
/**
 *  @class mysql_manager mysql_manager.hh "com/centreon/broker/storage/mysql_manager.hh"
 *  @brief Class managing the mysql thread connections
 *
 *  Here is a mysql threads manager. It creates, destroyes, configures mysql_connections.
 */
class                   mysql_manager {
 public:
