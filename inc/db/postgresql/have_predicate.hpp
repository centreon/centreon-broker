...
#ifndef DB_POSTGRESQL_HAVE_PREDICATE_HPP_
# define DB_POSTGRESQL_HAVE_PREDICATE_HPP_
  ...
  namespace               DB
  {
      ...
      : virtual public HavePredicate<ObjectType>
    {
     private:
      ...
      /**
       *  PgSQLHavePredicate copy constructor.
       */
	...
	(void)pghp;
      ...
      /**
       *  PgSQLHavePredicate operator= overload.
       */
	...
	return (*this);
     ...
     public:
      /**
       *  PgSQLHavePredicate default constructor.
       */
                          PgSQLHavePredicate() {}

      /**
       *  PgSQLHavePredicate destructor.
       */
...
#endif /* !DB_POSTGRESQL_HAVE_PREDICATE_HPP_ */
