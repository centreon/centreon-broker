...
mapping::entry const service::entries[] = {
    mapping::entry(&service::acknowledged,
                   nullptr,
                   mapping::entry::always_valid,
                   true,
                   "acknowledged"),
    mapping::entry(&service::acknowledgement_type,
                   nullptr,
                   mapping::entry::always_valid,
                   true,
    ...
    mapping::entry(&service::check_period, "check_period"),
    ...
    mapping::entry(&service::downtime_depth,
                   nullptr,
                   mapping::entry::always_valid,
                   true,
    ...
    mapping::entry(&service::event_handler, "event_handler"),
    ...
    mapping::entry(&service::next_notification,
                   ...
                   true,
                   "next_notification"),
    mapping::entry(&service::no_more_notifications,
                   nullptr,
                   mapping::entry::always_valid,
                   true,
    ...
    mapping::entry(&service_status::notifications_enabled,
                   ...
                   true,
                   "notify"),
    mapping::entry(&service::notify_on_critical,
                   nullptr,
                   mapping::entry::always_valid,
                   true,
                   "notify_on_critical"),
    ...
    mapping::entry(static_cast<bool(service::*)>(&service::notify_on_recovery),
                   ...
                   true,
                   "notify_on_recovery"),
    mapping::entry(&service::notify_on_unknown,
                   nullptr,
                   mapping::entry::always_valid,
                   true,
                   "notify_on_unknown"),
    mapping::entry(&service::notify_on_warning,
                   nullptr,
                   mapping::entry::always_valid,
                   true,
                   "notify_on_warning"),
    mapping::entry(&service::obsess_over, "obsess_over_service"),
    mapping::entry(&service::passive_checks_enabled,
                   nullptr,
                   mapping::entry::always_valid,
                   true,
                   "passive_checks"),
    ...
    mapping::entry(&service::service_description, "description"),
    mapping::entry(&service::should_be_scheduled, "should_be_scheduled"),
    mapping::entry(&service::stalk_on_critical,
                   nullptr,
                   mapping::entry::always_valid,
                   true,
                   "stalk_on_critical"),
    mapping::entry(&service::stalk_on_ok,
                   nullptr,
                   mapping::entry::always_valid,
                   true,
                   "stalk_on_ok"),
    mapping::entry(&service::stalk_on_unknown,
                   nullptr,
                   mapping::entry::always_valid,
                   true,
                   "stalk_on_unknown"),
    mapping::entry(&service::stalk_on_warning,
                   nullptr,
                   mapping::entry::always_valid,
                   true,
                   "stalk_on_warning"),
    mapping::entry(&service::state_type, "state_type"),
    mapping::entry(&service::check_command, "check_command"),
    mapping::entry(&service::output, "output"),
    mapping::entry(&service::perf_data, "perfdata"),
    mapping::entry(
