...
class state {
 public:
  ...
  uint32_t auto_rescheduling_interval() const throw();
  void auto_rescheduling_interval(uint32_t value);
  uint32_t auto_rescheduling_window() const throw();
  void auto_rescheduling_window(uint32_t value);
  ...
  uint32_t check_reaper_interval() const throw();
  void check_reaper_interval(uint32_t value);
  ...
  uint32_t debug_verbosity() const throw();
  void debug_verbosity(uint32_t value);
  ...
  uint32_t event_handler_timeout() const throw();
  void event_handler_timeout(uint32_t value);
  ...
  uint32_t host_check_timeout() const throw();
  void host_check_timeout(uint32_t value);
  uint32_t host_freshness_check_interval() const throw();
  void host_freshness_check_interval(uint32_t value);
  ...
  uint32_t host_perfdata_file_processing_interval() const throw();
  void host_perfdata_file_processing_interval(uint32_t value);
  ...
  uint32_t interval_length() const throw();
  void interval_length(uint32_t value);
  ...
  uint32_t max_check_reaper_time() const throw();
  void max_check_reaper_time(uint32_t value);
  ...
  uint32_t max_host_check_spread() const throw();
  void max_host_check_spread(uint32_t value);
  unsigned long max_log_file_size() const throw();
  void max_log_file_size(unsigned long value);
  uint32_t max_parallel_service_checks() const throw();
  void max_parallel_service_checks(uint32_t value);
  uint32_t max_service_check_spread() const throw();
  void max_service_check_spread(uint32_t value);
  uint32_t notification_timeout() const throw();
  void notification_timeout(uint32_t value);
  ...
  uint32_t ochp_timeout() const throw();
  void ochp_timeout(uint32_t value);
  std::string const& ocsp_command() const throw();
  void ocsp_command(std::string const& value);
  uint32_t ocsp_timeout() const throw();
  void ocsp_timeout(uint32_t value);
  ...
  uint32_t retention_scheduling_horizon() const throw();
  void retention_scheduling_horizon(uint32_t value);
  uint32_t retention_update_interval() const throw();
  void retention_update_interval(uint32_t value);
  ...
  uint32_t service_check_timeout() const throw();
  void service_check_timeout(uint32_t value);
  uint32_t service_freshness_check_interval() const throw();
  void service_freshness_check_interval(uint32_t value);
  ...
  uint32_t service_perfdata_file_processing_interval() const throw();
  void service_perfdata_file_processing_interval(uint32_t value);
  ...
  uint32_t status_update_interval() const throw();
  void status_update_interval(uint32_t value);
  ...
  uint32_t time_change_threshold() const throw();
  void time_change_threshold(uint32_t value);
  ...
  void user(uint32_t key, std::string const& value);
 ...
 private:
  ...
  uint32_t _auto_rescheduling_interval;
  uint32_t _auto_rescheduling_window;
  ...
  uint32_t _check_reaper_interval;
  ...
  uint32_t _event_handler_timeout;
  ...
  set_host _hosts;
  uint32_t _host_check_timeout;
  uint32_t _host_freshness_check_interval;
  ...
  uint32_t _host_perfdata_file_processing_interval;
  ...
  uint32_t _max_check_reaper_time;
  unsigned long _max_check_result_file_age;
  unsigned long _max_debug_file_size;
  uint32_t _max_host_check_spread;
  unsigned long _max_log_file_size;
  uint32_t _max_parallel_service_checks;
  uint32_t _max_service_check_spread;
  uint32_t _notification_timeout;
  bool _obsess_over_hosts;
  bool _obsess_over_services;
  std::string _ochp_command;
  uint32_t _ochp_timeout;
  std::string _ocsp_command;
  uint32_t _ocsp_timeout;
  ...
  uint32_t _retention_scheduling_horizon;
  uint32_t _retention_update_interval;
  ...
  uint32_t _service_check_timeout;
  uint32_t _service_freshness_check_interval;
  ...
  uint32_t _service_perfdata_file_processing_interval;
  ...
  uint32_t _status_update_interval;
  set_timeperiod _timeperiods;
  uint32_t _time_change_threshold;
