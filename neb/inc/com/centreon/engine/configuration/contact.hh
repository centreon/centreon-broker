...
class contact : public object {
 public:
  ...
  uint32_t host_notification_options() const throw();
  ...
  uint32_t service_notification_options() const throw();
 ...
 private:
  ...
  opt<uint32_t> _host_notification_options;
  ...
  opt<uint32_t> _service_notification_options;
