...
namespace neb {
/**
 *  @class timeperiod_serializable timeperiod_serializable.hh
 * "com/centreon/broker/neb/timeperiod_serializable.hh"
 *  @brief Represent a serializable Centreon Engine Object File timeperiod.
 */
class timeperiod_serializable : public ceof::ceof_serializable {
 public:
  timeperiod_serializable(
      std::unordered_map<std::string, time::timeperiod::ptr> const& tps);
  timeperiod_serializable(timeperiod_serializable const& other);
  timeperiod_serializable& operator=(timeperiod_serializable const& other);
  ...
  time::timeperiod::ptr get_timeperiod() const;
