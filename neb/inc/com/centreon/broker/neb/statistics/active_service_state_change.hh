...
/**
 *  @class active_service_state_change active_service_state_change.hh
 * "com/centreon/broker/neb/statistics/active_service_state_change.hh"
 *  @brief active_service_state_change statistics plugin.
 */
class active_service_state_change : public plugin {
 public:
  active_service_state_change();
  active_service_state_change(active_service_state_change const& right);
  ~active_service_state_change();
  active_service_state_change& operator=(
