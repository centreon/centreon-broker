...
namespace         neb {
  namespace       statistics {
    /**
     *  @class active_service_state_change active_service_state_change.hh "com/centreon/broker/neb/statistics/active_service_state_change.hh"
    ...
    public:
                  ...
                  ~active_service_state_change();
      active_service_state_change&
                  operator=(active_service_state_change const& right);
