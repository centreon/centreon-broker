...
/**
 *  @class passive_services_last passive_services_last.hh
 * "com/centreon/broker/neb/statistics/passive_services_last.hh"
 *  @brief passive_services_last statistics plugin.
 */
class passive_services_last : public plugin {
 public:
  passive_services_last();
  passive_services_last(passive_services_last const& right);
  ~passive_services_last();
  passive_services_last& operator=(passive_services_last const& right);
