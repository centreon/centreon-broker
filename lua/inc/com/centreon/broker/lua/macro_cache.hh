...
class macro_cache {
 public:
  ...
  std::string const& get_notes_url(uint64_t host_id) const;
  std::string const& get_notes(uint64_t host_id) const;
  std::string const& get_action_url(uint64_t host_id) const;
